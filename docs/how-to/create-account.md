...
![Create Account Button](./assets/create-account/step-1-create-account.png)
...
![Email Field](./assets/create-account/step-2-fill-create-account-form-email.png)
...
![Organisation Name](./assets/create-account/step-3-set-new-organisation-details-name.png)
![Organisation Type](./assets/create-account/step-3-set-new-organisation-details-type.png)
...
![Agree to terms](./assets/create-account/step-5-agree-to-terms.png)
...
![Access Portal](./assets/create-account/step-6-access-commitment-portal.png)
