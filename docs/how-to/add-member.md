...
![Click Add Members](./assets/add-member/step-1-click-add-members.png)
...
![Select Role](./assets/add-member/step-2-select-role.png)

## Step 5: Send the Invitation

1. Click the button with the "Add user" icon (the person with a plus sign) to finalize the process.

![Add Access](./assets/add-member/step-2-click-add-access.png)
