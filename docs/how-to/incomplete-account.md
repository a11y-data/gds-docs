...
![Incomplete Account](./assets/complete-account/1-incomplete-account.png)
...
![Account Confirmation](./assets/complete-account/2-step-1-sign-in.png)
...
![Search Existing Organisation](./assets/complete-account/3-step-2-select-org.png)
![Request Role](./assets/complete-account/3-step-2-set-role.png)
...
![Create New Organisation](./assets/complete-account/3-step-2-org.png)
...
![Email Verification](./assets/complete-account/4-step-3-verify.png)
...
![Terms of Service](./assets/complete-account/5-step-4-terms.png)
...
![Success](./assets/complete-account/6-step-5--success.png)
